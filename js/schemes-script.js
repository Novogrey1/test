...
const translations = {
  "ru": {
    ...
    "Схема Троллейбусного Парка Главного Острова (оригинальное & проект \"TRP RP\")": "Схема Троллейбусного Парка Главного Острова (оригинальное & проект \"TRP RP\")",
    "Схема Троллейбусного Парка острова Хардбасс (оригинальное)": "Схема Троллейбусного Парка острова Хардбасс (оригинальное)",
    "Схема Троллейбусного Парка острова Хардбасс (проект TRP RP)": "Схема Троллейбусного Парка острова Хардбасс (проект TRP RP)",
    "Карта маршрутов (оригинальная + проект TRP RP)": "Карта маршрутов (оригинальная + проект TRP RP)"
  },
  "en": {
    "Главная": "Home",
    ...
    "Схемы троллейбусных парков и маршрутов": "Trolleybus Depot and Route Schemes",
    "Схема Троллейбусного Парка Главного Острова (оригинальное & проект \"TRP RP\")": "Main Island Trolleybus Depot Scheme (Original & TRP RP Project)",
    "Схема Троллейбусного Парка острова Хардбасс (оригинальное)": "Hardbass Island Trolleybus Depot Scheme (Original)",
    "Схема Троллейбусного Парка острова Хардбасс (проект TRP RP)": "Hardbass Island Trolleybus Depot Scheme (TRP RP Project)",
    "Карта маршрутов (оригинальная + проект TRP RP)": "Route Map (Original + TRP RP Project)"
  }
};
